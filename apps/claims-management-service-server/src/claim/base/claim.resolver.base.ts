...
export class ClaimResolverBase {
  ...
  @graphql.ResolveField(() => Policy, {
    nullable: true,
    name: "policy",
  })
  async getPolicy(@graphql.Parent() parent: Claim): Promise<Policy | null> {
    const result = await this.service.getPolicy(parent.id);
